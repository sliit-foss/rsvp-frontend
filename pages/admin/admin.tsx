...
import ModifiedSideNav from '../../components/Admin/ModifiedSideNav'
  ...
  return (
    <Layout title="Register | RSVP SLIIT">
      ...
      <section
        ...
        className="bg-no-repeat bg-right-top bg-cover grid grid-rows-1 grid-cols-1 md:grid-cols-8 gap-4 min-h-95vh"
      >
        <ModifiedSideNav
