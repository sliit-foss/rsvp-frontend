      ...
      <section className="grid grid-cols-1 grid-rows-1 md:grid-cols-2 gap-6 md:py-24 py-16">
        ...
        >
          ...
          <p className="md:text-left text-center text-gray-default max-w-lg md:mx-0 mx-auto mb-5">
            Here, at SLIIT, our intention is to improve people&apos;s life, and
            as we see education is the greatest opportunity that can be given to
            a person. We want to create a better society, where we can all
            develop our maximum potential through what we are passionate about.
            We talk to opinion leaders, philosophers, industrial experts and
            teachers who help us to be better people. We want to give society
            tools, experiences and knowledge so that all people can develop and
