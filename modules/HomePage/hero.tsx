    ...
    <section className='bg-gradient-to-r from-gradientBlue to-gradientPurple'>
      <Container>
        <section
          ...
          className='text-white grid grid-cols-1 grid-rows-1 md:grid-cols-2 gap-6'
        >
          <div className='md:col-span-1 flex flex-col justify-center'>
            ...
            <h1 className='font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-5 leading-snug'>
              JavaScript Fundamentals
            </h1>
            <div className='inline-flex items-center space-x-2'>
              <p className='font-medium'>Programming</p>
              <div className='text-gray-default bg-gray-light py-1 px-3 rounded-2xl'>
                #JavaScript
              </div>
              <div className='text-gray-default bg-gray-light py-1 px-3 rounded-2xl'>
                #SLIITFOSS
          ...
          <div className='md:col-span-1 flex flex-col justify-center items-start md:mb-0 mb-8'>
