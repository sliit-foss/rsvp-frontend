...
const WhatWeDo = () => {
  return (
    <Container>
      <section className='grid grid-cols-1 grid-rows-1 md:grid-cols-2 gap-6 md:pb-24 pb-16'>
        <div className='md:col-span-1 md:col-start-2 md:col-end-3 md:row-start-1 flex items-center justify-center max-w-lg lg:w-auto sm:w-80 w-64 mx-auto my-8'>
          <Image
            src={whatWeDo}
            alt='foss logo'
            layout='intrinsic'
