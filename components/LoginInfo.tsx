...
const LoginInfo = (props:LoginInfoProps): JSX.Element => {
    ...
    const outerContainerClass = "flex flex-col items-center justify-center lg:justify-center lg:w-6/12 lg:items-center";
    const paragraphClass = "text-center text-textBlackTertiary mb-6 lg:text-left lg:w-5/6 lg:text-sm lg:p-6";
