    ...
    <div className="lg:flex lg:flex-row bg-gradient-to-r from-gradientBlue to-gradientPurple">
      <div className="sm:w-full lg:w-1/3">
        ...
        <div className="relative -top-8">
          <div>
            <p className="pl-10 pr-10 text-white mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem
              eaque voluptatum iure
              veniam praesentium enim iusto est, omnis tenetur reiciendis harum, perferendis
              porro alias dicta, impedit temporibus! Dolores, totam exercitationem?</p>
          </div>
      ...
      <div className="relative sm:w-full lg:w-1/3">
        <div className="w-full h-1/4">
          <div className="lg:pt-14">
            <h4 className="relative left-10 w-1/2 sm:w-1/2 md:w-1/2 text-xl font-bold mb-1 text-white">Useful Links</h4>
          ...
          <div className="flex flex-row w-full text-white pl-10 pr-10">
            <div className="sm:mt-5 sm:mb-5 md:mt-5 md:mb-5 w-full">
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque incidunt
                ea quisquam impedit deleniti illum quis libero blanditiis non architecto
                quidem praesentium amet voluptas ab cupiditate, suscipit neque ut pariatur?</p>
              <div className="flex flex-row item-center mb-5">
                ...
                />
                <button
                  className="w-11 h-11  bg-blue mt-5 shadow-md hover:bg-gradientPurple duration-150 transition ease-in font-medium rounded-lg block relative -left-7">
                  <FaRegEnvelope className="transform -rotate-12  relative top-0 left-0 right-0 bottom-0 m-auto"
                                 size="25" />
                </button>
              </div>
            </div>
