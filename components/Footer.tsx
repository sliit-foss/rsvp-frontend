...
import { FaFacebook , FaInstagram , FaLinkedin , FaTwitter , FaRegEnvelope} from "react-icons/fa";
...
<div className="lg:flex lg:flex-row bg-gradient-to-r from-gradientBlue to-gradientPurple">
    <div className="sm:w-full lg:w-1/3">
        ...
        <div className='relative -top-8'>
            <div>
                <p className='pl-10 pr-10 text-white mb-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem eaque voluptatum iure 
                         ...
                         <div className='flex flex-row item-center mb-5'>
                             ...
                             className='p-2 mt-5 w-3/4 rounded-lg block text-black shadow-md'
                              ...
                              <button className='w-11 h-11  bg-blue mt-5 shadow-md hover:bg-gradientPurple duration-150 transition ease-in font-medium rounded-lg block relative -left-7'>
                                <FaRegEnvelope className='transform -rotate-12  relative top-0 left-0 right-0 bottom-0 m-auto' size='25'/>
                              </button>
                         </div>
                 </div>
             </div>
